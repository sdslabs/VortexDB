<!-- Source: https://rootex.readthedocs.io/en/latest/engine/inputs.html -->

Inputs — Rootex documentation
- Inputs
# Inputs
...
[Class InputManager](https://rootex.readthedocs.io/en/latest/api/class_input_manager.html#class-inputmanager) handles the input for the entire engine. The input manager is initially feeded with a collection of ‘input schemes’. These input schemes are defined in the level JSON files likewise:
```
