<!-- Source: https://rootex.readthedocs.io/en/latest/guides/editor_layout.html -->

Editor Layout — Rootex documentation
- Editor Layout
# Editor Layout
...
-
Rotation
Select and entity and press W. In this mode the gizmo takes the shape of 3 circles with their axes going in orthogonal directions. These circles denote the rotation of the entities in Euler angles and rotation of the entities can be altered by dragging.
-
Scale
