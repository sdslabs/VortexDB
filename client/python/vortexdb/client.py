...
# The basic operations
    ...
    def search(
        ...
        *,
        ...
        Accepts:
        - vector + similarity + limit
        - SearchQuery object via `query`
        ...
        if query is not None:
            ...
            if not isinstance(similarity, Similarity):
                raise TypeError("similarity must be Similarity enum")
    ...
    def batch_search(
        ...
        *,
        ...
        request = proto.build_batch_search_request(queries=normalized)
